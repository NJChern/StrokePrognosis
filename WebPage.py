...
with col1:
    ...
    selected_PLT = st.slider('PLT(Platelet Count)-(×10^9/L)', min_value=0.0, max_value=1000.0, step=1)
    selected_FIB = st.slider('FIB(Fibrinogen)-(mg/dL)', min_value=0.0, max_value=1000.0, step=1)
